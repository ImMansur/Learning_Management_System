...
VOICE_MAP = {
    ...
    "zh-Hans": "zh-CN-XiaoxiaoNeural",  # Chinese (full code)
    "zh": "zh-CN-XiaoxiaoNeural",  # Chinese (short code)
...
def translate_text(text: str, target_lang: str) -> str:
    ...
    # Map short codes to Azure Translator codes
    translator_lang = "zh-Hans" if target_lang == "zh" else target_lang

    # Construct URL
    endpoint = "https://api.cognitive.microsofttranslator.com"
    path = f'/translate?api-version=3.0&to={translator_lang}'
